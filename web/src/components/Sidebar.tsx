...
import { LayoutDashboard, MessageSquare, PlusCircle, GitBranch, ShieldCheck, FolderOutput, Archive } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/system', icon: ShieldCheck, label: 'System Check' },
